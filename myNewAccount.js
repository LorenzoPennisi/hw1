...
function checkSignup(event) {
  const checkbox1 = document.querySelector('input[name="allow1"]');
  const checkbox2 = document.querySelector('input[name="allow2"]');

  formStatus[checkbox1.name] = checkbox1.checked;
  formStatus[checkbox2.name] = checkbox2.checked;

  if (Object.keys(formStatus).length !== 9 || !checkbox2.checked) {
    const mess = document.querySelector('.mess')
    mess.textContent = "Accettare la clausola sul trattamento dei dati";
    mess.classList.add('errorj');  
