...
<head>
  ...
  <link rel="icon" type="image/png" sizes="32x32" href="https://shop.akinformatica.it/wp-content/themes/ak-informatica/dist/images/favicon/favicon-32x32.png" />
  <link rel="icon" type="image/png" sizes="16x16" href="https://shop.akinformatica.it/wp-content/themes/ak-informatica/dist/images/favicon/favicon-16x16.png" />

  <link rel="preconnect" href="https://fonts.googleapis.com" />
  <link rel="preconnect" href="https://fonts.gstatic.com" crossorigin />
  <link href="https://fonts.googleapis.com/css2?family=IBM+Plex+Sans:ital,wght@0,100;0,200;0,300;0,400;0,500;0,600;0,700;1,100;1,200;1,300;1,400;1,500;1,600;1,700&display=swap" rel="stylesheet" />

  <title>Profilo <?php if (checkAuth()) {
                    echo $userinfo['username'];
                  } ?> - Ak Informatica</title>
</head>
...
<body>
  ...
  <section>
    ...
    <p class="benvenuto">
      &nbsp;Ciao <?php //echo $userinfo['name']
                  ?> benvenuto nell'<span class="grassetto">AkShop</span>. Qui troverai
      &nbsp;lo stato dei tuoi ordini, i tuoi articoli preferiti e potrai accedere in qualsiasi momento al tuo carello!<br><br>
      &nbsp;Buona Navigazione!
    </p>
    ...
    <div id="navigazione">
      ...
      <div id="link">
        ...
        <div id="info-profilo" class="info-item">
          <span>
            Dettagli Profilo
          </span>
        </div>
        ...
        <!--
        <div id="articoli-salvati" class="info-item">
          <span>
            Articoli Salvati Per Dopo
          </span>
        </div>

        <div id="ordini" class="info-item">
          <div>
            <span>
              I tuoi Ordini
            </span>
      ...
      <div id="risultati">
        ...
        <div class="banner">
          <form name='dati-utente' method='post' enctype="multipart/form-data" autocomplete="off">
  ...
  <footer>
    <div class="footer2">
      <a href="https://shop.akinformatica.it/serve-aiuto/" title="Serve aiuto?">
        <div id="footer-icon-1">
          <figure><img src="https://shop.akinformatica.it/wp-content/uploads/2022/01/ak-serve-aiuto.png" alt="" decoding="async" loading="lazy"></figure>
          <span>Serve aiuto?</span>
        </div>
      </a>
      <a href="https://shop.akinformatica.it/negozi-e-contatti/" title="Negozi &amp; Contatti">
        <div id="footer-icon">
          <figure><img src="https://shop.akinformatica.it/wp-content/uploads/2022/01/ak-negozi.png" alt="" decoding="async" loading="lazy"></figure>
          <span>Negozi &amp; Contatti</span>
        </div>
      </a>
      <a href="https://shop.akinformatica.it/spedizioni-e-resi/" title="Spedizione &amp; Resi">
        <div id="footer-icon">
          <figure><img src="https://shop.akinformatica.it/wp-content/uploads/2022/01/ak-spedizione.png" alt="" decoding="async" loading="lazy"></figure>
          <span>Spedizione &amp; Resi</span>
        </div>
      </a>
      <a href="https://shop.akinformatica.it/pagamenti/" title="Pagamento &amp; Rimborsi">
        <div id="footer-icon">
          <figure><img src="https://shop.akinformatica.it/wp-content/uploads/2022/01/ak-pagamenti.png" alt="" decoding="async" loading="lazy"></figure>
          <span>Pagamento &amp; Rimborsi</span>
        </div>
      </a>
      <a href="https://shop.akinformatica.it/ak-big-warranty/" title="AK big Warranty">
        <div id="footer-icon-5">
          <figure class="float-left"><img src="https://shop.akinformatica.it/wp-content/uploads/2022/01/ak-big-warranty.png" alt="" decoding="async" loading="lazy"></figure>
    ...
    <div id="footer2">
      ...
      <div id="social">
        ...
        <a href="https://www.instagram.com/akinformaticagaming" title="Linkedin">
