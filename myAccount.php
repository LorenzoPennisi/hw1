<?php
    ...
    {
        //si connette utilizzando le credeziali dentro l'array dbconfig, se la connessione non
        //ha successo mostra l'errore e il codice php viene interrotto da die()
        $conn = mysqli_connect($dbconfig['host'], $dbconfig['user'], $dbconfig['password'], $dbconfig['name']) or die(mysqli_error($conn));

        //utilizzata per proteggere il valore della variabile $_POST['username'] da caratteri speciali che potrebbero alterare la query SQL.
...
<head>
  ...
  <title>My Account - Ak Informatica</title>
</head>
...
<body>
  ...
  <section>
    ...
    <div class="banner">
      <form name = 'logic' method = 'post'>

        <div class="username">
          <label for="username">Nome utente o indirizzo email&nbsp;<span>*</span></label> 
          <input type="text" name="username" id="username" <?php if(isset($_POST["username"])){echo "value=".$_POST["username"];} ?>>
        </div>
        
        <div class="password">
          <label for="password">Password&nbsp;<span>*</span></label> <span class="password-input">
          <input type="password" name="password" id="password" <?php if(isset($_POST["password"])){echo "value=".$_POST["password"];} ?>><span></span>
        </div>
    ...
    <div class="registrazione">
      ...
      <a href="myNewAccount.php">Registrati</a>
    </div>
  </section>
