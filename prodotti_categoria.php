...
<head>
  ...
  <script src="prodotti_categoria.js" defer></script>
  ...
  <link
    ...
    rel="stylesheet"/>
  <title>Prodotti <?php if(isset($_GET['categoria'])){ echo $_GET['categoria']; } ?> </title>
</head>
...
<body>
  <div class="scroll">
    ...
    <header>
      <div id="bottoni">
        ...
        <div id="categModal" class="hidden">
          ...
          <div class="itemCatMod">
            <a href="prodotti_categoria.php?categoria=Memoria">- Memorie ></a>
          </div>
        </div>
    ...
    <section>
      <div class="main">
        <div class="Prod" data-categoria="<?php if(isset($_GET['categoria'])){ echo $_GET['categoria']; } ?>">
